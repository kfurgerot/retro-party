  ...
  return (
    <header className="sticky top-0 z-30 flex h-14 items-center gap-3 border-b border-[var(--ds-border)] bg-[var(--ds-bg)]/80 px-4 backdrop-blur-xl">
      ...
      <button
        ...
        className={cn(
          "ds-focus-ring group flex h-9 flex-1 items-center gap-2.5 rounded-lg border border-[var(--ds-border)] bg-[var(--ds-surface-1)]",
      ...
      >
        ...
        <span className="flex-1 truncate">Rechercher, lancer, rejoindre…</span>
        <kbd className="hidden items-center gap-0.5 rounded border border-[var(--ds-border)] bg-[var(--ds-surface-2)] px-1.5 py-0.5 text-[10px] font-medium text-[var(--ds-text-faint)] sm:flex">
          ⌘K
        </kbd>
      </button>
      ...
      <div className="ml-auto flex items-center gap-2">
        ...
        <button
          type="button"
          onClick={onOpenPalette}
          className="ds-focus-ring flex h-9 items-center gap-1.5 rounded-lg border border-indigo-400/40 bg-indigo-500 px-3 text-[13px] font-semibold text-white shadow-[0_4px_16px_rgba(99,102,241,0.35)] transition hover:bg-indigo-400"
        >
          <Plus size={14} />
