  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        selected ? "border-pink-400 bg-pink-500/20 shadow-[0_0_0_1px_rgba(236,72,153,0.24)]" : "border-pink-400/25 bg-slate-900/55",
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        {quantityLabel ? <div className="text-sm font-bold text-pink-200">{quantityLabel}</div> : null}
      </div>
    </Comp>
  );
};
