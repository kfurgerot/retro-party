...
- faible friction à l’entrée
- cohérence entre modules
- lisibilité immédiate
- valeur de facilitation concrète
- rendu soigné mais simple
- expérience engageante (inspiration jeu)
- utilisable facilement par des équipes réelles
...
- une présence des autres utilisateurs (multijoueur vivant)
- une expérience agréable sans être gadget

---

## Contraintes

- parcours compréhensibles pour des utilisateurs non techniques
- excellente compatibilité mobile
- ajout de fonctionnalités sans dégrader l’existant
- robustesse du temps réel
- stabilité des sessions multijoueurs
...
- proposer des refontes si elles apportent de la valeur

Une proposition ne doit pas se limiter à l’existant si une meilleure solution est possible.
...
- simplifier l’usage
- ou augmenter la valeur perçue

Sinon, il doit être remis en question.